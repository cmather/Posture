...
task "setup" do
  ...
  puts "****************************************"
  puts ""
  puts "Development environment setup complete! You can start by running the tests by typing 'rake test'. You can play around with the library with the test application by typing 'rake server'. That will launch the test server which is located in runner/. Enjoy! -Chris"
end