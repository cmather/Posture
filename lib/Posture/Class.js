define(["Posture/Core"], function(Posture) {
  ...
  var Class = function Class(definition, context) {
    ...
    if (_.has(definition, "Extends")) {
      ...
      if (_.isUndefined(SuperClass)) throw new Error(namespace.namespace + ": you're trying to extend an undefined class. Make sure to include it. ");
    ...
    PostureClass._meta.namespace = namespace.namespace;
